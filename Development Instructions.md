# my-library
[![Build Status](https://travis-ci.org/robisim74/my-library.svg?branch=master)](https://travis-ci.org/robisim74/my-library)
...
Get the [Changelog](https://github.com/robisim74/my-library/blob/master/CHANGELOG.md).
...
2. Rename `my-library` and `angularLibraryStarter` everywhere to `my-library` and `myLibrary`.
...
1. `package.json`
    ...
    * `"main": "./bundles/my-library.umd.js"` legacy module format 
    * `"module": "./bundles/my-library.es5.js"` flat _ES_ module, for using module bundlers such as _Rollup_ or _webpack_: 
    [package module](https://github.com/rollup/rollup/wiki/pkg.module)
    * `"es2015": "./bundles/my-library.js"` _ES2015_ flat _ESM_ format, experimental _ES2015_ build
